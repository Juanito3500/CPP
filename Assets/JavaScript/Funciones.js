...
function insertarReglasCSSAdicionalesEnString(reglasCSS){
    let elementoStyle = document.createElement('style');
    elementoStyle.innerHTML = reglasCSS;
    document.head.appendChild(elementoStyle);
}

function insertarReglasCSSAdicionalesEnStyle(styleElement){
    document.head.appendChild(styleElement);
}

function quitarReglasCSSAdicionalesEnStyle(styleElement){
